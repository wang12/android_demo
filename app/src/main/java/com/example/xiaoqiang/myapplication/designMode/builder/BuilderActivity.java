...
public class BuilderActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        stringBuffer.append(new Mobile.Builder().bindCpu("魅族").bindCell("魅族").bindExterior("红色").build().toString());
        stringBuffer.append("\n通过建造者模式创建小米手机对象\n");
        stringBuffer.append(new Mobile.Builder().bindCpu("小米").bindCell("小米").bindExterior("蓝色").build().toString());
